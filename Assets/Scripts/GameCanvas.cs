...
public class GameCanvas : MonoBehaviour
{
    ...
    InventoryTabChangerUI inventoryMenuScript = null;
    ItemsInventoryUI itemsInventoryMenuScript = null;
    StatsInventoryUI statsInventoryMenuScript = null;
    AchievementsInventoryUI achievementsInventoryMenuScript = null;
    GalleryinventoryUI galleryInventoryMenuScript = null;
    ...
    public InventoryTabChangerUI InventoryMenuScript { get => inventoryMenuScript; set => inventoryMenuScript = value; }
    public ItemsInventoryUI ItemsInventoryMenuScript { get => itemsInventoryMenuScript; set => itemsInventoryMenuScript = value; }
    public StatsInventoryUI StatsInventoryMenuScript { get => statsInventoryMenuScript; set => statsInventoryMenuScript = value; }
    public AchievementsInventoryUI AchievementsInventoryMenuScript { get => achievementsInventoryMenuScript; set => achievementsInventoryMenuScript = value; }
    public GalleryinventoryUI GalleryInventoryMenuScript { get => galleryInventoryMenuScript; set => galleryInventoryMenuScript = value; }
    ...
    {
        achievementsInventoryMenuScript = windowsMenu.GetComponent<AchievementsInventoryUI>();
        ...
        galleryInventoryMenuScript=windowsMenu.GetComponent<GalleryinventoryUI>();
        informationsMenuScript=informationsMenu.GetComponent<InformationsMenu>();
        inventoryMenuScript=windowsMenu.GetComponent<InventoryTabChangerUI>();
        itemEquipMenuScript=windowsMenu.GetComponent<ItemEquipMenu>();
        itemsCityMenuScript=cityMenu.GetComponent<ItemsCityMenu>();
        itemsInventoryMenuScript=windowsMenu.GetComponent<ItemsInventoryUI>();
        ...
        statsInventoryMenuScript=windowsMenu.GetComponent<StatsInventoryUI>();
